...
import com.mysqldemo.demo.event.*;
import com.mysqldemo.demo.view.BaseFrame;
import com.mysqldemo.demo.view.MouseMovementDetector;
import com.mysqldemo.demo.view.action.StandardAction;
import com.mysqldemo.demo.view.action.mediaplayer.MediaPlayerActions;
import com.mysqldemo.demo.view.snapshot.SnapshotView;
...
import static com.mysqldemo.demo.Application.resources;
    ...
    public MainFrame() {
        ...
        mediaPlayerComponent.getMediaPlayer().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
            ...
            public void mediaPlayerReady(MediaPlayer mediaPlayer) {
                ...
                try {
                    logo = Logo.logo()
                            .image(ImageIO.read(getClass().getResource("/vlcj-logo.png")))
                ...
                Marquee marquee = Marquee.marquee()
                        .text(String.format("tonghua-player"))
